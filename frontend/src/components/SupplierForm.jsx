...
const SupplierForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSupplier({ firmName: "", supplierName: "", address: "", phone: "" });
      ...
      <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg border border-gray-200 p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 mt-8">
            {/* Green Gradient Save Supplier Button */}
            <button
              type="submit"
              disabled={loading}
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
              Clear Form
            </button>
          </div>
